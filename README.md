...
```sh
curl -fsSL https://raw.githubusercontent.com/interkelstar/floo/v0.5.2/floo \
...
`github.com/interkelstar/floo/tree/v0.5.2`.
...
```sh
curl -fsSL https://raw.githubusercontent.com/interkelstar/floo/v0.5.2/bin/floo-powder -o floo-powder
