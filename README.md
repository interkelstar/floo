...
```sh
curl -fsSL https://raw.githubusercontent.com/interkelstar/floo/v0.7.2/floo \
...
```sh
bash <(curl -fsSL https://raw.githubusercontent.com/interkelstar/floo/v0.7.2/bin/floo-powder) \
...
```sh
curl -fsSL https://raw.githubusercontent.com/interkelstar/floo/v0.7.2/bin/floo-powder -o floo-powder
